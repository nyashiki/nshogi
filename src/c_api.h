...
typedef struct nshogi_solver_api {
    ...
    nshogi_move_t (*solveByDfPn)(nshogi_state_t*, nshogi_solver_dfpn_t*,
                                 long max_node_count, int max_depth);
} nshogi_solver_api_t;
...
typedef struct nshogi_io_api {
    ...
    int (*canCreateMoveFromSfen)(const nshogi_state_t* state,
            const char* sfen);
    ...
    int32_t (*stateToSfen)(char* dest, int32_t max_length, const nshogi_state_t* state);
    int32_t (*positionToSfen)(char* dest, int32_t max_length, const nshogi_position_t* state);
} nshogi_io_api_t;
