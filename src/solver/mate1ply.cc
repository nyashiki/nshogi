...
template<core::Color C>
core::Move32 solveImpl(const core::internal::StateImpl& S) {
...
template <core::Color C>
core::Move32 solver::mate1ply::internal::solve(const core::internal::StateImpl& S) {
...
core::Move32 solver::mate1ply::solve(const core::State& S) {
    ...
    return internal::solve<C>(*Adapter.get());
}

template
core::Move32 solver::mate1ply::internal::solve<core::Color::Black>(const core::internal::StateImpl&);
template
core::Move32 solver::mate1ply::internal::solve<core::Color::White>(const core::internal::StateImpl&);
