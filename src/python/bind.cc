...
class PyFeatureStack {
 public:
    PyFeatureStack(const std::vector<nshogi::ml::FeatureType>& Types, const nshogi::core::State& S, const nshogi::core::StateConfig& Config)
    : FeatureStack(Types, S, Config) {

    }

    pybind11::array_t<float> to_numpy() const {
        auto NpArray = pybind11::array_t<float>((pybind11::ssize_t)nshogi::core::NumSquares * (pybind11::ssize_t)FeatureStack.size());
...
PYBIND11_MODULE(nshogi, Module) {
    ...
    pybind11::class_<nshogi::core::Move32>(Module, "Move")
        ...
        .def_property_readonly("capture_piece_type", &nshogi::core::Move32::capturePieceType)
    ...
    pybind11::class_<nshogi::core::Position>(Module, "Position")
        ...
        .def("get_stand_count", [](const nshogi::core::Position& Pos, nshogi::core::Color C, nshogi::core::PieceTypeKind Type) {
            return Pos.getStandCount(C, Type);
        })
        .def("to_sfen", [](const nshogi::core::Position& Pos) {
            return nshogi::io::sfen::positionToSfen(Pos);
        })
        .def("to_csa", [](const nshogi::core::Position& Pos) {
            return nshogi::io::csa::positionToCSA(Pos);
        })
        .def_property_readonly("side_to_move", &nshogi::core::Position::sideToMove);
    ...
    pybind11::class_<nshogi::core::State>(Module, "State")
        ...
        .def("get_stand_count", [](const nshogi::core::State& State, nshogi::core::Color C, nshogi::core::PieceTypeKind Type) {
    ...
    pybind11::class_<nshogi::core::StateConfig>(Module, "StateConfig")
        ...
        .def_readwrite("black_draw_value", &nshogi::core::StateConfig::BlackDrawValue)
        .def_readwrite("white_draw_value", &nshogi::core::StateConfig::WhiteDrawValue);
    ...
    SfenModule.def("move_from_sfen", [](const nshogi::core::State& State, const std::string& Sfen){
    ...
    CSAModule.def("move_from_csa", [](const nshogi::core::State& State, const std::string& CSA){
    ...
    pybind11::enum_<nshogi::ml::FeatureType>(MLModule, "FeatureType")
        ...
        .value("MY_DECLARATION_SCORE", nshogi::ml::FeatureType::FT_MyDeclarationScore)
        .value("OP_DECLARATION_SCORE", nshogi::ml::FeatureType::FT_OpDeclarationScore)
    ...
    pybind11::class_<nshogi::ml::AZTeacher>(MLModule, "AZTeacher")
        .def("state", [](const nshogi::ml::AZTeacher& T) {
            auto State = nshogi::io::sfen::StateBuilder::newState(std::string(T.Sfen));

            return State;
        })
        .def("config", [](const nshogi::ml::AZTeacher& T) {
        ...
        .def("sfen", [](const nshogi::ml::AZTeacher& T) {
            return T.Sfen;
        })
        .def("policy", [](const nshogi::ml::AZTeacher& T) {
            ...
            for (uint8_t I = 0; I < T.NumMoves; ++I) {
                const auto Move = nshogi::io::sfen::sfenToMove32(State.getPosition(), std::string(T.Moves[I].data()));
                const std::size_t Index = nshogi::ml::getMoveIndex(T.SideToMove, Move);
                Data[Index] = (float)T.Visits[I] / (float)SumVisits;
            }

            return NpArray;
        })
        .def("legal_moves", [](const nshogi::ml::AZTeacher& T) {
            auto NpArray = pybind11::array_t<float>((pybind11::ssize_t)nshogi::ml::MoveIndexMax);
            auto Data = reinterpret_cast<float*>(NpArray.request().ptr);
        ...
        .def("attacks", [](const nshogi::ml::AZTeacher& T) {
        ...
        .def("value", [](const nshogi::ml::AZTeacher& T) {
    ...
    pybind11::class_<nshogi::ml::TeacherLoaderForFixedSizeTeacher<nshogi::ml::AZTeacher>>(MLModule, "AZTeacherLoader")
        ...
        .def("filter", [](const nshogi::ml::TeacherLoaderForFixedSizeTeacher<nshogi::ml::AZTeacher>& Loader, const std::string& OutputPath) {
