...
PYBIND11_MODULE(nshogi, Module) {
    ...
    pybind11::enum_<nshogi::ml::FeatureType>(MLModule, "FeatureType")
        ...
        .value("MY_BISHOP_AND_PROBISHOP", nshogi::ml::FeatureType::FT_MyBishopAndProBishop)
        .value("MY_ROOK_AND_PROROOK", nshogi::ml::FeatureType::FT_MyRookAndProRook)
        ...
        .value("OP_BISHOP_AND_PROBISHOP", nshogi::ml::FeatureType::FT_OpBishopAndProBishop)
        .value("OP_ROOK_AND_PROROOK", nshogi::ml::FeatureType::FT_OpRookAndProRook)
