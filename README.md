...
## License
This repository includes some resources in the `res/` directory that are sourced from [https://yaneuraou.yaneu.com/2020/12/25/christmas-present/](やねうら王公式からクリスマスプレゼントに詰将棋500万問を謹呈).
